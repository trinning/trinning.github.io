...
<col width="33%" />
  ...
  <tbody>
    <tr>
      <td markdown="span">![Åsa Björkman]({{ '/assets/osa_200px.jpg' | relative_url }})</td>
      <td markdown="span">![Karin Sjöberg]({{ '/assets/karin_200px.jpg' | relative_url }})</td>
      <td markdown="span">![Anna Dahlgren]({{ '/assets/anna_200px.jpg' | relative_url }})</td>
    </tr>
    <tr>
